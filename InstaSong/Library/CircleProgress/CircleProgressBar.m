...
- (void)drawHint:(CGContextRef)context center:(CGPoint)center radius:(CGFloat)radius {
    ...
    CGSize hintTextSize = [progressString boundingRectWitAdamze:CGSizeZero options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName: self.hintTextFontForDrawing} context:nil].size;
